...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo $baseURL ?>site">
    ...
    <!-- 
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo $baseURL ?>site/transaction/">
          <i class="fas fa-fw fa-retweet"></i>
          <span>Transaction</span></a>
      </li>
    
      <li class="nav-item">
        <a class="nav-link" href="<?php echo $baseURL ?>site/products/">
          <i class="fas fa-fw fa-retweet"></i>
    ...
    <!-- End of Sidebar -->
    <?php  include_once $basePath.'includes/topbar.php'; ?>
