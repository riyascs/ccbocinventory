    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo $baseURL ?>pages/logout.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="cust_transac.php?action=add">
            ...
            <div class="form-group">
              <input class="form-control" placeholder="Code" name="lastname" >
            </div>
            <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="emp_transac.php?action=add">          
			  ...
			  $site =getSites();
			  ?>
                <select class="form-control" id="site" placeholder="Site" name="site" required>
					<option value="" disabled selected hidden>Select Site</option>
				<?php
				if($site) foreach($site as $one){
