...
$opt .= "</select>";
        ...
        $query = "SELECT u.EMPLOYEE_ID , e.FIRST_NAME, e.LAST_NAME, e.GENDER, USERNAME, PASSWORD, e.EMAIL, PHONE_NUMBER, j.JOB_TITLE, e.HIRED_DATE, t.TYPE, s.code
                      FROM users u
                      join employee e on u.EMPLOYEE_ID = e.EMPLOYEE_ID
                      join job j on e.JOB_ID=j.JOB_ID
                      join site s on e.SITE=s.id
                      join type t on u.TYPE_ID=t.TYPE_ID
                      WHERE u.EMPLOYEE_ID  =".$_SESSION['MEMBER_ID'];
        $result = mysqli_query($db, $query) or die(mysqli_error($db));
        ...
        <div class="card shadow mb-4 col-xs-12 col-md-12 border-bottom-primary">
            ...
            <form role="form" method="post" action="settings_edit.php">
              ...
              <div class="form-group row text-left text-primary">
                ...
                <div class="col-sm-9">
                  <input class="form-control" placeholder="Province" name="province" value="<?php echo $j; ?>" readonly>
                </div>
              </div>
