...
<?php
  ...
  $query = 'SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME,GENDER, EMAIL, PHONE_NUMBER, j.JOB_TITLE, HIRED_DATE, S.code FROM employee e join site S on e.SITE = s.id join job j on j.JOB_ID=e.JOB_ID WHERE e.EMPLOYEE_ID ='.$_GET['id'];
  $result = mysqli_query($db, $query) or die(mysqli_error($db));
